...
class TokyotabWidget extends StatelessWidget {
  const TokyotabWidget({super.key});
    ...
    return Scaffold(
      body: Row(
        children: [
         ...
         Padding(
          padding: EdgeInsets.only(left: width*0.18, top: height*0.35),
           child: Container(
            height: height*0.08,
            width: width*0.24,
            color: Colors.black,
          ...
          Padding(
          padding: EdgeInsets.only(left: width*0.18, top: height*0.06),
           child: Container(
            height: height*0.08,
            width: width*0.28,
            color: Colors.black,
